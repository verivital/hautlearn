...
static void initSimStructsc3_bouncing_ball(SFc3_bouncing_ballInstanceStruct
  *chartInstance);
static void c3_eml_ini_fcn_to_be_inlined_129(SFc3_bouncing_ballInstanceStruct
  *chartInstance);
static void c3_eml_term_fcn_to_be_inlined_129(SFc3_bouncing_ballInstanceStruct
  *chartInstance);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2669888114U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1226850237U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3910186741U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3939311974U);
}
...
mxArray *sf_c3_bouncing_ball_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("StD9ePYxzF9n7RgaD4meN");
...
static void mdlSetWorkWidths_c3_bouncing_ball(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3473472466U));
  ssSetChecksum1(S,(4079643948U));
  ssSetChecksum2(S,(89476697U));
  ssSetChecksum3(S,(2497347949U));
