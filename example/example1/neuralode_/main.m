...
global sigma num_var num_ud Ts winlen Time act_function nL hS
Time = false;
Ts  = 0.05;
sigma = 0.003;  
winlen = 10;
...
t3 = toc;
%%
FnHystNODE_('automata_learning',label_guard, num_var, ode, pta_trace);
...
try
    spaceex2cora('automata_learning.xml',0,'automata_learning_sys','ex1_node',pwd);
catch
end
