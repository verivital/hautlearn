...
try
    spaceex2cora('automata_learning.xml',0,'automata_learning_sys','spikeN_nl',pwd);
catch
end
...
%% Notes
% The self-transition with a reset does not seem to work. Not sure why, but 
% I guess it is how the hautlearn framework was developed
% It could be either due to the reset part of it, or because it is assuming
% that self-transitions are not possible. We need to dig into this a little
% more
