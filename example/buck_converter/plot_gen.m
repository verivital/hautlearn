...
%%
fid_original = fopen('r_original_x1_x2.gen'); 
Vs_original = load('r_original_x1_x2.gen');
newline = sprintf('\n');
...
%%
fid_inferred = fopen('r_inferred_x1_x2.gen'); 
Vs_inferred = load('r_inferred_x1_x2.gen');
newline = sprintf('\n');
