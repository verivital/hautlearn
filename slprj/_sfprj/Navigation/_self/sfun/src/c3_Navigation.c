...
static uint8_T c3_f_emlrt_marshallIn(SFc3_NavigationInstanceStruct
  *chartInstance, const mxArray *c3_c_tp_S1, const char_T *c3_identifier);
  ...
  *chartInstance, const mxArray *c3_c_tp_S1, const char_T *c3_identifier)
{
  ...
  c3_thisId.fParent = NULL;
  c3_thisId.bParentIsCell = false;
  c3_b_y = c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_c_tp_S1),
    &c3_thisId);
  sf_mex_destroy(&c3_c_tp_S1);
  return c3_b_y;
}
...
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  const mxArray *c3_c_tp_S1;
  const char_T *c3_identifier;
  emlrtMsgIdentifier c3_thisId;
  uint8_T c3_b_y;
  SFc3_NavigationInstanceStruct *chartInstance;
  chartInstance = (SFc3_NavigationInstanceStruct *)chartInstanceVoid;
  c3_c_tp_S1 = sf_mex_dup(c3_mxArrayInData);
  c3_identifier = c3_varName;
  c3_thisId.fIdentifier = (const char *)c3_identifier;
  c3_thisId.fParent = NULL;
  c3_thisId.bParentIsCell = false;
...
mxArray *sf_c3_Navigation_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("gXFHeiJLLkzgmEjr9UTEsE");
